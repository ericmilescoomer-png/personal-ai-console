...
More than 340 contract tests, across more than fifty modules, exist for one reason: to make the trust model's promises break the build if they are ever violated. Among the invariants pinned this way:
