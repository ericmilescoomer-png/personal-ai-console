...
- **Asymmetric signing (gap).** Audit, receipt, and per-agent bindings are keyed tamper-evidence, not third-party-provable non-repudiation &mdash; asymmetric signing is the next step.
