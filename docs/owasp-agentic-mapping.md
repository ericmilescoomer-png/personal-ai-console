...
- **Detection depth (gap).** Containment is the load-bearing defense; classifier-based injection screening and behavioral anomaly detection would add depth on top of it.
